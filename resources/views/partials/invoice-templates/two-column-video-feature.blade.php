@php
    ...
    $acfFieldData = get_field('two_column_video_feature');
    ...
    $videoSource = $acfFieldData['video_source'];
    ...
    $headingWeight = $acfFieldData['heading_weight'] ? $acfFieldData['heading_weight'] : 'h2';
@endphp
...
<div id="{{$ctaId}}" class="two-column-video-feature-container container">
