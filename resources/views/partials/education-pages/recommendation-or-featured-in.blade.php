    ...
    <section class="lpat-recommendation__wrapper">
        <div class="lpat-recommendation__content">
          ...
          <div class="lpat-recommendation__image-wrapper">
            @include('partials.components.global-image', ['img' => $image,'classes'=>'lpat-recommendation__image'])
          </div>
          @endif
...
@else
  <div class="featured-in container">
    <section>
      <span class="copy">{{ get_field('education_featured_label', 'option') }}</span>
      @php($logos_list = get_field('education_featured_logos','options'))
