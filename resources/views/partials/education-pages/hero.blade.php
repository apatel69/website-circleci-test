@php
    ...
    $bg_img = get_field('education_desktop_hero_image','options')["global_image"]['url'];
    $tablet_bg_img = get_field('education_tablet_hero_image','options')["global_image"]['url'];
    $mobile_bg_img = get_field('education_mobile_hero_image','options')["global_image"]['url'];
    $hero_description = get_field('education_hero_description','options');
    ...
    $alternative_hero_image = get_field('education_custom_hero_image','options')["global_image"]['url'];
