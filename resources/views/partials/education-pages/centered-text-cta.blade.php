@php
    ...
    $trial_outlined_text = !empty(get_field('trial_cta_outlined')['text']) ? get_field('trial_cta_outlined')['text'] : get_field('education_centered_text', 'options');
    $trial_outlined_subtext = !empty(get_field('trial_cta_outlined')['subtext']) ? get_field('trial_cta_outlined')['subtext'] : get_field('education_centered_sub_text','options');
@endphp
    ...
    <section class="centered-text-cta">
        <div class="centered-text-cta__content">
            ...
            <div class="centered-text-cta__cta">
                <a href="{{ $trial_url }}" class="primary-cta" target="_blank" rel="noopener">{{ $trial_cta_copy }} for {{ $trial_length }} Days</a>
            </div>
