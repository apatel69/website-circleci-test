<div class="container">
    ...
    @if (get_field('education_benefits_title','options'))
      <h2 class="lpat-three-col-content__benefits-title">{{get_field('education_benefits_title','options')}}</h2>
    @endif
    @if (have_rows('education_benefits_list','options'))
      <div class="lpat-three-col-content__benefits-list">
        @while(have_rows('education_benefits_list','options')) @php(the_row())
