@php
$title = get_field('lpat_support_title','options');
$description = get_field('lpat_support_description','options');
$contact_us_title = get_field('lpat_contact_us_title','options');
$phone = get_field('lpat_support_phone','options');
$email = get_field('lpat_support_email','options');
$image_desktop = get_field('lpat_support_image_desktop','options');
$image_mobile = get_field('lpat_support_image_mobile','options');
@endphp
