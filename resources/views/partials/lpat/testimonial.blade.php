<div class="container" id="customer-testimonials">
  <section class="testimonials">
      @if (get_field('lpat_section_title','options'))
          <h2>{{ get_field('lpat_section_title','options') }}</h2>
      @endif
      @if (have_rows('lpat_testimonials','options'))
          <div class="smux-testimonials">
              @while (have_rows('lpat_testimonials','options')) @php(the_row())
