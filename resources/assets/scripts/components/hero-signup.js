...
$(document).ready(function() {
    setTrialLength();
    new nfbInlineSignupForm($, window, document, $('#inline-form-hero'));
    new nfbInlineSignupForm($, window, document, $('#inline-form-body'));
    $(".inline-form-hero .fieldset-email").click(function() {
        $(".inline-form-hero .fieldset-password").slideDown();
    });
